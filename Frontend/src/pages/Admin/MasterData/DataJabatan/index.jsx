            ...
            items.push(
                <button
                    ...
                    className={`py-2 px-4 border border-gray-2 text-black font-semibold dark:text-white dark:border-strokedark ${currentPage === page
                        ...
                        : 'hover:bg-gray-2 dark:hover:bg-stroke'} rounded-lg`}
                >
                    {page}
                </button>
            );
                    ...
                    <table className='w-full table-auto'>
                        <thead>
                            <tr className='bg-gray-2 text-left dark:bg-meta-4'>
                                ...
                                <th className='py-4 px-4 font-medium text-black dark:text-white'>Base Salary</th>
                ...
                <div className="flex justify-between items-center mt-4 flex-col md:flex-row md:justify-between">
                    <div className="flex items-center space-x-2">
                        <span className="text-gray-5 dark:text-gray-4 text-sm py-4">
                            Showing {startIndex + 1}-{Math.min(endIndex, filteredDataJabatan.length)} of {filteredDataJabatan.length} Positions
                        </span>
                    </div>
