...
export const Me = async (req, res) => {
  ...
  }).select('id_pegawai nik nama_pegawai username hak_akses');
...
export const changePassword = async (req, res) => {
  ...
  const user = await DataPegawai.findById(userId);
  ...
  try {
    ...
    await DataPegawai.findByIdAndUpdate(user._id, {
